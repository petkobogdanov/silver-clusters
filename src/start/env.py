...
_env['DATA_PATH'] = os.path.abspath( os.path.join(_env['MAIN'], "data"))
...
envList = {"MAIN": _env['MAIN'], "DATA_PATH": _env['DATA_PATH'], "SRC_PATH": _env['SRC_PATH'],"MERCI_PATH" : _env['MERCI_PATH'],
